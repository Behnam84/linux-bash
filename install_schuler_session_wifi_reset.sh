...
command -v nmcli >/dev/null 2>&1 || die "nmcli is missing. Install the network-manager package."
[[ -e /lib/*/security/pam_exec.so || -e /usr/lib/*/security/pam_exec.so ]] || \
    die "pam_exec.so is missing. Install the libpam-modules package."
